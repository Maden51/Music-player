...
// TODO: Добавить возможность добавлять свои песни.
// TODO: Добавить полоску времени к песням.
// TODO: Добавить микшер громкости.
...
const shuffle = () => {
  for (let i = userData?.songs.length - 1; i > 0; i--) {
    ...
    const temp = userData.songs[i];
    userData.songs[i] = userData.songs[j];
    userData.songs[j] = temp;
  }
